...
export default function DeliverySettingsPage() {
  ...
  async function save() {
    ...
    for (const s of settings) {
      const val = s.key === 'manual_quote_message' ? message : s.key === 'manual_quote_whatsapp' ? whatsapp : s.key === 'global_delivery_price' ? globalPrice : s.value;
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <Card className="p-6">
        ...
        <div className="text-sm text-white-muted space-y-2">
          ...
          <p><strong className="text-white">Route Not Found:</strong> The manual quote message is displayed and order is still accepted.</p>
